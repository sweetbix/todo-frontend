...
function RegisterForm({ showRegister, onClose, setIsLoggedIn, setUsernameGlobal }) {
    ...
    return (
        ...
        className="flex justify-center items-center bg-black bg-opacity-50 z-10 fixed inset-0">
            <div className="flex flex-col bg-grey1 w-[60%] sm:w-[50%] md:w-[40%] lg:w-[25%] rounded-xl
            relative z-5">
                <h1 className="text-2xl font-bold text-center pt-4 text-yellow-500">Create an account</h1>
