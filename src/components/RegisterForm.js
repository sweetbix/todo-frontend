...
function RegisterForm({ showRegister, onClose }) {
    ...
    return (
        <div className="flex justify-center items-center bg-black bg-opacity-20 z-10 fixed w-full min-h-screen">
            ...
            relative">
                ...
                <button onClick={onClose} className="absolute top-1 right-1 border-2 border-black z-10 text-lg
                rounded-3xl p-1 pl-2 pr-2"> 
                    X
                </button>
